...
[Существует](https://github.com/sanmai/cdek-sdk) хард-форк этой библиотеки, с даунгрейдом до php 7.0, расширенными функционалом и документацией. Мы обязательно сделаем бэкпорт всего этого добра, как только дойдут руки )
